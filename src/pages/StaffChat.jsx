...
export default function StaffChat() {
          ...
          return (
            <div
              ...
              style={{
                ...
                marginBottom: 2,
                background: isSelected && !isMobile ? '#dcfce7' : 'transparent',
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                <div style={{
                  ...
                  color: isSelected && !isMobile ? '#15803d' : theme.textDark,
  ...
  const chatPane = (
    <div style={{
      flex: 1, background: '#fff', border: isMobile ? 'none' : `1px solid ${theme.border}`,
